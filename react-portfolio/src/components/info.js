...
export default function Info() {
    return (
        <div>
            ...
            <p>Welcome! Thank you for taking the time to visit my portfolio! My name is Taylor Brandon. My web development journey started over two years ago with an eagerness to learn and quickly adapt, which has led me to work on diverse project from personal and professional endeavors to collaborative efforts in Columbia University’s Full-Stack Development Bootcamp, where I established my programming skills.
